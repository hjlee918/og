// Electron Forge configuration for the F27 OUTGOING feature build.
//
...
//   ..          <clone>                          (this feature clone's root)
//   ../..       development/f27-outgoing-context (beside the clone)
...
module.exports = {
  ...
  packagerConfig: {
    name: 'Logseq-OG-F27-Outgoing',
    icon: './icons/pilot.icns',
    buildVersion: '92-f27outgoing',
    appBundleId: 'com.logseq.logseq-og.f27outgoing',
