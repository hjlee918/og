...
'use strict';
//
// Packages the F27 outgoing feature application with `electron-forge package`.
//
...
// productName, so the .app is Logseq-OG-F27-Outgoing.app while the display name
// inside Info.plist (CFBundleName) is "Logseq OG F27 Outgoing".
