...
'use strict';
//
// Reproducible build of the F27 OUTGOING feature application.
//
//   node f27-outgoing/scripts/build-feature.js
//
...
const pkg = Object.assign({}, basePkg, {
  ...
  version: `${basePkg.version}-f27outgoing.1`,
  main: 'pilot-main.js',
  description: 'Isolated local F27 outgoing-context feature build of Logseq OG. Not for distribution.',
});
...
const manifest = {
  ...
  guardSources: 'f27-pilot/src (unchanged); identity from f27-outgoing/src/feature-identity.js',
  artifacts,
