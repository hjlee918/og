'use strict';
//
// Identity constants for the F27 INLINE-CONTEXT FEATURE build.
//
...
module.exports = Object.freeze({
  SCHEMA: 'f27-inline/1',
  PRODUCT_NAME: 'Logseq OG F27 Inline',
  BUNDLE_ID: 'com.logseq.logseq-og.f27inline',
  PACKAGE_NAME: 'logseq-og-f27-inline',
  ...
  OWNERSHIP_MARKER: 'F27-INLINE-OWNED.json',
