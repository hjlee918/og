// Electron Forge configuration for the F27 INLINE-CONTEXT feature build.
//
...
//   ../..       development/f27-inline-context   (beside the clone)
...
module.exports = {
  ...
  packagerConfig: {
    name: 'Logseq-OG-F27-Inline',
    icon: './icons/pilot.icns',
    buildVersion: '92-f27inline',
    appBundleId: 'com.logseq.logseq-og.f27inline',
