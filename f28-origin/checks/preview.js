...
function packageIdentity(){
  ...
  const expected=process.arch==='arm64'
    ? {build:'2026-09-11T22-07-22-370Z-4750cad0',source:'87b811663a298cb5a6ae4d4f73836a9ebc45a2a9',manifest:'8a3e818e851f7d3f6cce05cfb922198c5a7fe51f8d00a0cab784e5bd9d30dc23'}
    : {build:'2026-09-11T18-21-00-039Z-918adc55',source:'352b3ea7003e7c7c41b96fcc4271f5c88e841c71',manifest:'2df86456ce068cdeb4725c5e4a0984a5cae23c559f5242175819f84efb8a1d8d'};
  assert(m.pilotBuildId===expected.build,'Wrong preview build');
  assert(m.builtFrom.commit===expected.source&&!m.builtFrom.dirty,'Wrong preview source');
  assert(m.host?.platform==='darwin'&&m.host?.arch===process.arch,'Wrong preview architecture');
  ...
  assert(hash===expected.manifest,'Manifest changed');
  return b;
}
