// Electron Forge configuration for the ORIGIN EXPERIMENT build.
//
...
const OUT_DIR = path.resolve(__dirname, '..', '..', 'out-originexp')

module.exports = {
  outDir: OUT_DIR,

  packagerConfig: {
    name: 'Logseq-OG-F28-OriginExp',
    icon: './icons/pilot.icns',
    buildVersion: '92-f28originexp',
    appBundleId: 'com.logseq.logseq-og.f28originexp',
