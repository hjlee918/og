...
'use strict';
//
// Reproducible build of the F28 SOURCE-PATH feature application.
//
//   node f28-refpath/scripts/build-feature.js
//
...
const SRC = path.join(REPO, 'f28-refpath', 'src');
...
const pkg = Object.assign({}, basePkg, {
  ...
  version: `${basePkg.version}-f28refpath.1`,
  main: 'pilot-main.js',
  description: 'Isolated local F28 source-path feature build of Logseq OG. Not for distribution.',
});
